  ...
  return (
    <div className="flex flex-col items-center justify-start px-4 py-10 animated-bg">
      ...
      <div className="relative z-10 w-full max-w-4xl mt-12">
        <div
          className="bg-neutral-900/90 border border-neutral-800 shadow-2xl rounded-2xl overflow-hidden
            ...
            <table className="w-full min-w-[700px] text-center text-white">
              ...
              <tbody>
                ...
                {filteredTasks.map((data, idx) => (
                  <tr
                    key={idx}
                    className="transition-all duration-200 hover:bg-neutral-800/80 md:hover:-translate-y-[1px]"
                  >
                    ...
                    <td className="flex justify-center p-4 space-x-2 border-b border-neutral-800">
                      <button
                        className="px-4 py-2 bg-blue-600 rounded-lg shadow-sm
                             md:hover:bg-blue-500 md:hover:shadow-[0_0_18px_rgba(59,130,246,0.8)]
                             md:hover:-translate-y-0.5 md:hover:scale-105
